...
describe('[Outputs]', () => {
  ...
  it('should create a genericS3 output', done => {
    outputClient.genericS3
      .create(sampleGenericS3Output)
      .then(response => {
        assert(response.id !== null && response.id !== undefined && response.id !== '');
