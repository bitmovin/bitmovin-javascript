...
describe('[Inputs]', () => {
  ...
  it('should create a genericS3 input', done => {
    inputsClient.genericS3
      .create(sampleGenericS3Input)
      .then(response => {
        assert(response.id !== null && response.id !== undefined && response.id !== '');
