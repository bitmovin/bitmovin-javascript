...
describe('[DASH Manifest ContentProtections]', () => {
  ...
  it('should add a content protection to a dash adaptation set', (done) => {
    ...
    .contentProtections.add(contentProtection).then((protection) => {
  ...
  it('should list content protections of a dash adaptation set', (done) => {
    manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets(adaptationSetResource.id)
    .contentProtections.list(5).then((response) => {
  ...
  it('should return content protection details of a dash adaptation set', (done) => {
    ...
    .contentProtections.add(contentProtection).then((protection) => {
      ...
      compareContentProtections(protection, contentProtection);
      return manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets(adaptationSetResource.id)
      .contentProtections(protection.id).details();
    }).then((details) => {
  ...
  it('should delete a content protection of a dash adaptation set', (done) => {
    ...
    .contentProtections.add(contentProtection).then((protection) => {
      ...
      compareContentProtections(protection, contentProtection);
      return manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets(adaptationSetResource.id)
      .contentProtections(protection.id).delete();
    }).then((result) => {
  ...
  it('should add a content protection to a dash fmp4 representation', (done) => {
    ...
    manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets(adaptationSetResource.id)
    .representations.fmp4(fmp4RepresentationResource.id).contentProtections.add(contentProtection)
    .then((protection) => {
      assert((protection.id !== null) && protection.id !== undefined && protection.id !== '');
      compareContentProtections(protection, contentProtection);
      done();
  ...
  it('should list content protections of a dash fmp4 representation', (done) => {
    manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets(adaptationSetResource.id)
    .representations.fmp4(fmp4RepresentationResource.id).contentProtections.list(5).then((response) => {
      assert((response.totalCount !== null) && response.totalCount !== undefined);
      assert((response.items !== null) && response.items !== undefined);
      done();
    }).catch((error) => {
  ...
  it('should return content protection details of a dash fmp4 representation', (done) => {
    ...
    .then((protection) => {
      ...
      compareContentProtections(protection, contentProtection);
      return manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets(adaptationSetResource.id)
      .representations.fmp4(fmp4RepresentationResource.id).contentProtections(protection.id).details();
    }).then((details) => {
      compareContentProtections(details, createdContentProtection);
      done();
    }).catch((error) => {
  ...
  it('should delete a content protection of a dash fmp4 representation', (done) => {
    ...
    .then((protection) => {
      ...
      compareContentProtections(protection, contentProtection);
      return manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets(adaptationSetResource.id)
      .representations.fmp4(fmp4RepresentationResource.id).contentProtections(protection.id).delete();
    }).then((result) => {
      assert.equal(result.id, createdContentProtection.id);
      done();
    }).catch((error) => {
  ...
  it('should add a content protection to a dash drmFmp4 representation', (done) => {
    ...
    manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets(adaptationSetResource.id)
    .representations.drmFmp4(drmFmp4RepresentationResource.id).contentProtections.add(contentProtection)
    .then((protection) => {
      assert((protection.id !== null) && protection.id !== undefined && protection.id !== '');
      compareContentProtections(protection, contentProtection);
      done();
  ...
  it('should list content protections of a dash drmFmp4 representation', (done) => {
    manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets(adaptationSetResource.id)
    .representations.drmFmp4(drmFmp4RepresentationResource.id).contentProtections.list(5).then((response) => {
      assert((response.totalCount !== null) && response.totalCount !== undefined);
      assert((response.items !== null) && response.items !== undefined);
      done();
    }).catch((error) => {
  ...
  it('should return content protection details of a dash drmFmp4 representation', (done) => {
    ...
    .then((protection) => {
      ...
      compareContentProtections(protection, contentProtection);
      return manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets(adaptationSetResource.id)
      .representations.drmFmp4(drmFmp4RepresentationResource.id).contentProtections(protection.id).details();
    }).then((details) => {
      compareContentProtections(details, createdContentProtection);
      done();
    }).catch((error) => {
  ...
  it('should delete a content protection of a dash drmFmp4 representation', (done) => {
    ...
    .then((protection) => {
      ...
      compareContentProtections(protection, contentProtection);
      return manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets(adaptationSetResource.id)
      .representations.drmFmp4(drmFmp4RepresentationResource.id).contentProtections(protection.id).delete();
    }).then((result) => {
      assert.equal(result.id, createdContentProtection.id);
      done();
    }).catch((error) => {
