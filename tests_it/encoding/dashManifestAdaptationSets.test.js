...
describe('[DASH Manifest AdaptationSets]', () => {
  ...
  it('should create a dash manifest audio adaptation set', (done) => {
    manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets.audio
    .create(sampleAudioAdaptationSet).then((adaptationSet) => {
  ...
  it('should list dash manifest audio adaptation sets', (done) => {
    manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets.audio.list(5).then((response) => {
  ...
  it('should return dash manifest audio adaptation set details', (done) => {
    ...
    .create(sampleAudioAdaptationSet).then((adaptationSet) => {
      assert((adaptationSet.id !== null) && adaptationSet.id !== undefined && adaptationSet.id !== '');
      compareAudioAdaptationSets(adaptationSet, sampleAudioAdaptationSet);
      return manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets.audio(adaptationSet.id)
      .details();
    }).then((details) => {
  ...
  it('should create a dash manifest video adaptation set', (done) => {
    manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets.video
    .create(sampleVideoAdaptationSet).then((adaptationSet) => {
      assert((adaptationSet.id !== null) && adaptationSet.id !== undefined && adaptationSet.id !== '');
  ...
  it('should list dash manifest video adaptation sets', (done) => {
    manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets.video.list(5).then((response) => {
      assert((response.totalCount !== null) && response.totalCount !== undefined);
      assert((response.items !== null) && response.items !== undefined);
      done();
    }).catch((error) => {
  ...
  it('should return dash manifest video adaptation set details', (done) => {
    ...
    .create(sampleVideoAdaptationSet).then((adaptationSet) => {
      assert((adaptationSet.id !== null) && adaptationSet.id !== undefined && adaptationSet.id !== '');
      compareVideoAdaptationSets(adaptationSet, sampleVideoAdaptationSet);
      return manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets.video(adaptationSet.id)
      .details();
    }).then((details) => {
  ...
  it('should create a dash manifest subtitle adaptation set', (done) => {
    manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets.subtitle
    .create(sampleSubtitleAdaptationSet).then((adaptationSet) => {
      assert((adaptationSet.id !== null) && adaptationSet.id !== undefined && adaptationSet.id !== '');
  ...
  it('should list dash manifest subtitle adaptation sets', (done) => {
    manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets.subtitle.list(5).then((response) => {
      assert((response.totalCount !== null) && response.totalCount !== undefined);
      assert((response.items !== null) && response.items !== undefined);
      done();
    }).catch((error) => {
  ...
  it('should return dash manifest subtitle adaptation set details', (done) => {
    ...
    .create(sampleSubtitleAdaptationSet).then((adaptationSet) => {
      assert((adaptationSet.id !== null) && adaptationSet.id !== undefined && adaptationSet.id !== '');
      compareSubtitleAdaptationSets(adaptationSet, sampleSubtitleAdaptationSet);
      return manifestsClient(manifestResource.id).periods(periodResource.id).adaptationSets.subtitle(adaptationSet.id)
      .details();
    }).then((details) => {
