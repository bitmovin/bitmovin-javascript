...
describe('[Infrastructure]', () => {
  ...
  it('should create new kubernetes infrastructure', done => {
    infrastructureClient.kubernetes
      .create(sampleKubernetesInfrastructure)
      .then(response => {
  ...
  it('should get kubernetes details and custom data', done => {
    infrastructureClient.kubernetes
      ...
      .then(kubernetesDetailResponse => {
        assert(
          kubernetesDetailResponse.id !== null &&
            kubernetesDetailResponse.id !== undefined &&
            kubernetesDetailResponse.id !== ''
        );
        ...
        assert(
          kubernetesDetailResponse.agentDeploymentDownloadUrl !== null &&
            kubernetesDetailResponse.agentDeploymentDownloadUrl !== undefined &&
            kubernetesDetailResponse.agentDeploymentDownloadUrl !== ''
        );
