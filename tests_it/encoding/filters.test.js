...
describe('[Filters]', () => {
  ...
  it('should create a watermark filter', done => {
    filtersClient.watermark
      .create(sampleWatermarkFilter)
      .then(response => {
  ...
  it('should create a rotate filter', done => {
    filtersClient.rotate
      .create(sampleRotateFilter)
      .then(response => {
        assert(response.id !== null && response.id !== undefined && response.id !== '');
  ...
  it('should create a deinterlace filter', done => {
    filtersClient.deinterlace
      .create(sampleDeinterlaceFilter)
      .then(response => {
        assert(response.id !== null && response.id !== undefined && response.id !== '');
