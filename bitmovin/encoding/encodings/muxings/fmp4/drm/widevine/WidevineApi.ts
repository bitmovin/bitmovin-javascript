...
export default class WidevineApi extends BaseAPI {
     ...
     * @param {WidevineDrm} [widevineDrm] TODO Add Description
    ...
    public create(encodingId: string, muxingId: string, widevineDrm?: WidevineDrm): Promise<WidevineDrm> {
        ...
        return this.restClient.post<WidevineDrm>('/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/widevine', pathParamMap, widevineDrm);
    }
    ...
    public delete(encodingId: string, muxingId: string, drmId: string): Promise<BitmovinResponse> {
        ...
        return this.restClient.delete<BitmovinResponse>('/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/widevine/{drm_id}', pathParamMap);
    }
    ...
    public get(encodingId: string, muxingId: string, drmId: string): Promise<WidevineDrm> {
        ...
        return this.restClient.get<WidevineDrm>('/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/widevine/{drm_id}', pathParamMap);
    }
    ...
    public list(encodingId: string, muxingId: string, queryParams?: WidevineDrmsListQueryParams): Promise<PaginationResponse<WidevineDrm>> {
        ...
        return this.restClient.get<PaginationResponse<WidevineDrm>>('/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/widevine', pathParamMap, queryParams);
    }
