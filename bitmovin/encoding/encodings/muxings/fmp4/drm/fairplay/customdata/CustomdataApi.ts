...
export default class CustomdataApi extends BaseAPI {
    ...
    /**
     * @summary FairPlay DRM Custom Data of fMP4
    ...
    public getCustomData(encodingId: string, muxingId: string, drmId: string): Promise<CustomData> {
        ...
        return this.restClient.get<CustomData>('/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/fairplay/{drm_id}/customData', pathParamMap);
    }
