...
export default class CustomdataApi extends BaseAPI {
    ...
    /**
     * @summary TTML Embed Custom Data
    ...
    public getCustomData(encodingId: string, muxingId: string, captionsId: string): Promise<CustomData> {
        ...
        return this.restClient.get<CustomData>('/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/captions/ttml/{captions_id}/customData', pathParamMap);
    }
