...
export default class CustomdataApi extends BaseAPI {
    ...
    /**
     * @summary ClearKey DRM Custom Data of MP4
    ...
    public getCustomData(encodingId: string, muxingId: string, drmId: string): Promise<CustomData> {
        ...
        return this.restClient.get<CustomData>('/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/clearkey/{drm_id}/customData', pathParamMap);
    }
