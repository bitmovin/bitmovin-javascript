...
export default class CustomdataApi extends BaseAPI {
    ...
    /**
     * @summary PlayReady DRM Custom Data of MP4
    ...
    public getCustomData(encodingId: string, muxingId: string, drmId: string): Promise<CustomData> {
        ...
        return this.restClient.get<CustomData>('/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/playready/{drm_id}/customData', pathParamMap);
    }
