...
export default class CencApi extends BaseAPI {
    ...
    public create(encodingId: string, muxingId: string, cencDrm?: CencDrm): Promise<CencDrm> {
        ...
        return this.restClient.post<CencDrm>('/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/cenc', pathParamMap, cencDrm);
    }

    /**
     * @summary Delete CENC DRM from MP4
     * @param {string} encodingId Id of the encoding.
    ...
    public delete(encodingId: string, muxingId: string, drmId: string): Promise<BitmovinResponse> {
        ...
        return this.restClient.delete<BitmovinResponse>('/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/cenc/{drm_id}', pathParamMap);
    }

    /**
     * @summary CENC DRM Details of MP4
     * @param {string} encodingId Id of the encoding.
     * @param {string} muxingId Id of the MP4 muxing.
     * @param {string} drmId Id of the cenc drm.
     * @throws {RequiredError}
    ...
    public get(encodingId: string, muxingId: string, drmId: string): Promise<CencDrm> {
        ...
        return this.restClient.get<CencDrm>('/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/cenc/{drm_id}', pathParamMap);
    }
    ...
    public list(encodingId: string, muxingId: string, queryParams?: CencDrmsListQueryParams): Promise<PaginationResponse<CencDrm>> {
        ...
        return this.restClient.get<PaginationResponse<CencDrm>>('/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/cenc', pathParamMap, queryParams);
    }
