...
export default class FairplayApi extends BaseAPI {
    ...
    public create(encodingId: string, muxingId: string, fairPlayDrm?: FairPlayDrm): Promise<FairPlayDrm> {
        ...
        return this.restClient.post<FairPlayDrm>('/encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/fairplay', pathParamMap, fairPlayDrm);
    }
    ...
    public delete(encodingId: string, muxingId: string, drmId: string): Promise<BitmovinResponse> {
        ...
        return this.restClient.delete<BitmovinResponse>('/encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/fairplay/{drm_id}', pathParamMap);
    }
    ...
    public get(encodingId: string, muxingId: string, drmId: string): Promise<FairPlayDrm> {
        ...
        return this.restClient.get<FairPlayDrm>('/encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/fairplay/{drm_id}', pathParamMap);
    }
    ...
    public list(encodingId: string, muxingId: string, queryParams?: FairPlayDrmsListQueryParams): Promise<PaginationResponse<FairPlayDrm>> {
        ...
        return this.restClient.get<PaginationResponse<FairPlayDrm>>('/encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/fairplay', pathParamMap, queryParams);
    }
