...
export default class FinishedApi extends BaseAPI {
    ...
    public create(webhook?: Webhook): Promise<Webhook> {
        return this.restClient.post<Webhook>('/notifications/webhooks/encoding/encodings/finished', {}, webhook);
    }
    ...
    public createByEncodingId(encodingId: string, webhook?: Webhook): Promise<Webhook> {
        ...
        return this.restClient.post<Webhook>('/notifications/webhooks/encoding/encodings/{encoding_id}/finished', pathParamMap, webhook);
    }
    ...
    public deleteByEncodingIdAndWebhookId(encodingId: string, webhookId: string): Promise<BitmovinResponse> {
        ...
        return this.restClient.delete<BitmovinResponse>('/notifications/webhooks/encoding/encodings/{encoding_id}/finished/{webhook_id}', pathParamMap);
    }
    ...
    public deleteByWebhookId(webhookId: string): Promise<BitmovinResponse> {
        ...
        return this.restClient.delete<BitmovinResponse>('/notifications/webhooks/encoding/encodings/finished/{webhook_id}', pathParamMap);
    }
    ...
    public getByEncodingIdAndWebhookId(encodingId: string, webhookId: string): Promise<Webhook> {
        ...
        return this.restClient.get<Webhook>('/notifications/webhooks/encoding/encodings/{encoding_id}/finished/{webhook_id}', pathParamMap);
    }
    ...
    public getByWebhookId(webhookId: string): Promise<Webhook> {
        ...
        return this.restClient.get<Webhook>('/notifications/webhooks/encoding/encodings/finished/{webhook_id}', pathParamMap);
    }
    ...
    public list(queryParams?: WebhooksListQueryParams): Promise<PaginationResponse<Webhook>> {
        return this.restClient.get<PaginationResponse<Webhook>>('/notifications/webhooks/encoding/encodings/finished', {}, queryParams);
    }
    ...
    public listByEncodingId(encodingId: string, queryParams?: WebhooksListByEncodingIdQueryParams): Promise<PaginationResponse<Webhook>> {
        ...
        return this.restClient.get<PaginationResponse<Webhook>>('/notifications/webhooks/encoding/encodings/{encoding_id}/finished', pathParamMap, queryParams);
    }
