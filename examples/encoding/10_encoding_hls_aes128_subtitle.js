...
const VTT_MEDIA_URL = '<YOUR_VTT_MEDIA_URL>';
    ...
    bitmovin.encoding
      ...
      .then(createdStream => {
        ...
        tsMuxingCreationPromise.then(([createdTsMuxing, createdFairPlayDrm, createdHlsDrmRepresentation]) => {
          resolve([createdStream, [[createdTsMuxing, createdFairPlayDrm, createdHlsDrmRepresentation]]]);
        });
      })
      .catch(
...
const createTSMuxingWithAESDRMAndManifestResources = (
  stream_,
  outputPath,
  codecConfiguration,
  output,
  ...
  return new Promise((resolve, reject) => {
    ...
    bitmovin.encoding
      ...
      .then(createdMuxing => {
        createAESDRMAndManifestResources(
          stream_,
          codecConfiguration,
          outputPath,
          createdMuxing,
...
const createAESDRMAndManifestResources = (
  stream_,
  codecConfiguration,
  outputPath,
  tsMuxing,
...
const createHlsVttMedia = (hlsManifest, vttUrl) => {
  return new Promise((resolve, reject) => {
    ...
    bitmovin.encoding.manifests
      ...
      .catch(logErrorPromise(reject, 'Unable to create HLS VTT Media'));
  });
};
