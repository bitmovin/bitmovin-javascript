    ...
    describe('groups', () => {
      describe('permissions', () => {
        ...
        describe('list', () => {
          assertItCallsCorrectUrl(
            'GET',
            urljoin('/v1/account/organizations', testOrgId, 'groups', testGroupId, 'permissions'),
            client.list
          );
        ...
        describe('permission', () => {
          ...
          describe('details', () => {
            assertItCallsCorrectUrl(
              'GET',
              urljoin('/v1/account/organizations', testOrgId, 'groups', testGroupId, 'permissions', testPermissionId),
