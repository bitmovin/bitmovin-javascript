...
import { sprites } from '../../bitmovin/encoding/sprites';
  ...
  describe('streams', () => {
    ...
    describe('stream', () => {
      describe('sprites', () => {
        ...
        describe('sprite', () => {
          describe('details', () => {
            assertItCallsCorrectUrl('GET', '/v1/encoding/encodings/encoding-id/streams/stream-id/sprites/sprite-id', client('sprite-id').details);
            assertItReturnsUnderlyingPromise(mockGet, client('sprite-id').details);
          });
          describe('customData', () => {
            assertItCallsCorrectUrl('GET', '/v1/encoding/encodings/encoding-id/streams/stream-id/sprites/sprite-id/customData', client('sprite-id').customData);
            assertItReturnsUnderlyingPromise(mockGet, client('sprite-id').customData);
          });
          describe('delete', () => {
            assertItCallsCorrectUrl('DELETE', '/v1/encoding/encodings/encoding-id/streams/stream-id/sprites/sprite-id', client('sprite-id').delete);
